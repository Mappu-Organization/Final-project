$(document).ready(function () {
    ...
    function populateTable() {
        ...
        <td style="text-align: center;">
          <button class="status-btn ${statusClass}" ${book.status === "Available" ? "disabled" : ""
                } 
            data-bs-toggle="modal" data-bs-target="#bookDetailsModal" data-student="${book.studentName
                }"
            data-borrowed="${book.borrowedDate}" data-return="${book.returnDate
                }">
            ${statusText}
          </button>
        </td>
